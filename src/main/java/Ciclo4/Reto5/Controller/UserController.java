...
import Ciclo4.Reto5.Services.UserServices;
...
public class UserController {
    ...
    public List<User> CumpleañosMes(@PathVariable("monthBirthtDay") String MonthBirthtDay){
        return UsersServices.CumpleañosMes(MonthBirthtDay);
    }
}