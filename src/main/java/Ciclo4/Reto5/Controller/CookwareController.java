...
import Ciclo4.Reto5.Services.CookwareServices;
...
public class CookwareController {
    ...
    public List<Cookware> FiltrarProductosPrecio(@PathVariable("price") String price){
        return ProductosServ.FiltrarProductosPrecio(price);
    }
    
    @GetMapping("/description/{description}")
    public List<Cookware> FiltrarProductosDesc(@PathVariable("description") String description){
        return ProductosServ.FiltrarProductosDesc(description);
    }
